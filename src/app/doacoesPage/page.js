      ...
      <main className="min-h-screen py-12 md:py-16 bg-[#f8f7f3]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden transition-shadow hover:shadow-xl">
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="space-y-4 mb-8">
                ...
                {(formaPagamento === "boleto" || formaPagamento === "cartao") && (
                  <div className="space-y-4 pt-2">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      <div>
                        <label htmlFor="cep" className="block text-sm font-bold text-gray-700 mb-2">
                          CEP *
                        </label>
                        <input
                          type="text"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                      ...
                      <div>
                        <label htmlFor="complemento" className="block text-sm font-bold text-gray-700 mb-2">
                          Complemento
                        </label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label htmlFor="bairro" className="block text-sm font-bold text-gray-700 mb-2">
                          Bairro *
                        </label>
                        <input
                          type="text"
          ...
          <div className="mt-12 bg-white rounded-2xl shadow-md p-6 text-center hover:shadow-lg transition-shadow">
            ...
            <button
              onClick={() => navigator.clipboard.writeText("55.009.533/0001-26")}
